...
public class GroupController extends BaseController {
	...
	public Object delete(@ApiParam(required = true, name = "token", value = "请求头token权限认证") @RequestHeader String token,
	...
	public Object reset(@ApiParam(required = true, name = "token", value = "请求头token权限认证") @RequestHeader String token,
			@ApiParam(required = true, name = "branchId", value = "分支id") @PathVariable String groupId,
	...
	public Object add(@ApiParam(required = true, name = "token", value = "请求头token权限认证") @RequestHeader String token,
			@Valid @RequestBody AddGroupParam param, BindingResult bingingresult, HttpServletRequest request)
			throws Exception {
	...
	public Object showGroupStatsByUser(@ApiParam(required = true, name = "id", value = "分支id") @PathVariable String id,
		...
		try {
			return setJson(SUCCESS_CODE,
					groupService.showStatsByUser(id, MongoDateUtil.getGroupOperation(id, dateformat, lastDate)));
		} catch (Exception e) {
	...
	public Object showProjectBranchStats(
			@ApiParam(required = true, name = "id", value = "分支id") @PathVariable String id,
			@RequestParam(required = false) @ApiParam(name = "dateformat", value = "时间格式") String dateformat,
			@RequestParam(required = false) @ApiParam(name = "lastDate", value = "时间范围") Integer lastDate) {
	...
	public Object showProjectBranchByUserAndDay(
			@ApiParam(required = true, name = "id", value = "分支id") @PathVariable String id,
			@RequestParam(required = false) @ApiParam(name = "dateformat", value = "时间格式") String dateformat,
			@RequestParam(required = false) @ApiParam(name = "lastDate", value = "时间范围") Integer lastDate) {
	...
	@ApiOperation(value = "根据时间和用户显示统计数据")
	public Object showProjectBranchByDayAndUser(
			@ApiParam(required = true, name = "id", value = "分支id") @PathVariable String id,
			@RequestParam(required = false) @ApiParam(name = "dateformat", value = "时间格式") String dateformat,
			@RequestParam(required = false) @ApiParam(name = "lastDate", value = "时间范围") Integer lastDate) {
	...
	public Object showProjectBranchStats(
		...
		try {
			return setJson(SUCCESS_CODE, groupService.statsByDay(MongoDateUtil.getFormat(dateformat),
					MongoDateUtil.getGroupOperation(null, dateformat, lastDate)));
		} catch (Exception e) {
